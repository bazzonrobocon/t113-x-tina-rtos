...
__attribute__((__unused__)) static rt_err_t telnet_init(rt_device_t dev) // fix unused-function
{
    return RT_EOK;
}

__attribute__((__unused__)) static rt_err_t telnet_open(rt_device_t dev, rt_uint16_t oflag) // fix unused-function
{
    return RT_EOK;
}

__attribute__((__unused__)) static rt_err_t telnet_close(rt_device_t dev) // fix unused-function
{
    return RT_EOK;
}
