...
__attribute__((__unused__)) static wmg_status_t freertos_monitor_connect() // fix unused-function
{
	return WMG_STATUS_SUCCESS;
}
...
__attribute__((__unused__)) static wmg_status_t freertos_monitor_disconnect() // fix unused-function
{
	return WMG_STATUS_SUCCESS;
}
