...
#define WMG_PLA_ACT_WIFI_SEND_80211_RAW_FRAME  0x3
#define WMG_PLA_ACT_WIFI_SET_COUNTRY_CODE      0x4
#define WMG_PLA_ACT_WIFI_GET_COUNTRY_CODE      0x5
#define WMG_PLA_ACT_WIFI_SET_PS_MODE           0x6
#define WMG_PLA_ACT_WIFI_LINKD_PROTOCOL        0x7
#define WMG_PLA_ACT_SCAN_PARAM                 0x8
#define WMG_PLA_ACT_SCAN_RESULTS               0x9
#define WMG_PLA_ACT_GET_WMG_STATE              0xa
#define WMG_PLA_ACT_VENDOR_SEND_DATA           0xb
#define WMG_PLA_ACT_VENDOR_REGISTER_RX_CB      0xc
#define WMG_PLA_ACT_SEND_EXPAND_CMD            0xd
