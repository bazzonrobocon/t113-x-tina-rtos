...
// fix unused-function
__attribute__((__unused__)) static struct bt_gatt_attr *handle_to_attr(btmg_gatt_db_t *db, uint16_t handle)
{
...
// fix unused-function
__attribute__((__unused__)) static uint8_t attr_foreach_func(const struct bt_gatt_attr *attr, uint16_t handle, void *user_data)
{
    return 0;
}
