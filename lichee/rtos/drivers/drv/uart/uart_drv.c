...
__attribute__((__unused__)) static sunxi_driver_uart_t uart0, uart1, uart2, uart3;
...
__attribute__((__unused__)) static sunxi_hal_poll_ops uart_poll_ops =
{
...
{
    __attribute__((__unused__)) struct devfs_node *node0, *node1, *node2, *node3;
