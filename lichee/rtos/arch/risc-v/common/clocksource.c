...
#define DEFAULT_CLOCKSOURCE_TIMER_CLK_FREQ (CONFIG_ARCH_TIMER_HZ)
...
#else
#define TIMER_FREQ    (CONFIG_ARCH_TIMER_HZ)

__attribute__((__unused__)) static uint32_t arch_timer_rate;
