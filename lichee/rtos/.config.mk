...
INCLUDES += -I $(BASE)/components/common/thirdparty/network/lwip-2.0.3/src/include/
endif
ifeq ($(CONFIG_COMPONENTS_LWIP_2_1_2), y)
INCLUDES += -I $(BASE)/components/common/thirdparty/network/lwip-2.1.2/src/include/
endif

WARNING_FLAGS := -g -Wall -Werror
EXPORT_CFLAGS += $(WARNING_FLAGS)

ifeq ($(CONFIG_FREERTOS_AW), y)
CC_KERNEL_VER = FreeRTOS
else ifeq ($(CONFIG_FREERTOS_V10_4_3), y)
CC_KERNEL_VER = FreeRTOS-orig
endif

ifeq ($(CONFIG_ARCH_SUN8IW18P1), y)
INCLUDES += -I $(BASE)/kernel/$(CC_KERNEL_VER)/Source/include/ -I $(BASE)/kernel/$(CC_KERNEL_VER)/Source/portable/GCC/ARM_CA9
INCLUDES += -I $(BASE)/include/arch/arm/armv7a/
INCLUDES += -I $(BASE)/include/arch/arm/mach/
endif

ifeq ($(CONFIG_ARCH_SUN8IW20P1)_$(CONFIG_ARCH_ARM_CORTEX_A7), y_y)
INCLUDES += -I $(BASE)/kernel/$(CC_KERNEL_VER)/Source/include/ -I $(BASE)/kernel/$(CC_KERNEL_VER)/Source/portable/GCC/ARM_CA9
INCLUDES += -I $(BASE)/include/arch/arm/armv7a/
INCLUDES += -I $(BASE)/include/arch/arm/mach/
endif
...
INCLUDES += -I $(BASE)/kernel/$(CC_KERNEL_VER)/Source/include/ -I $(BASE)/kernel/$(CC_KERNEL_VER)/Source/portable/GCC/ARM_CM33_NTZ/non_secure/
INCLUDES += -I $(BASE)/include/arch/arm/armv8m/
INCLUDES += -I $(BASE)/include/arch/arm/mach/
endif

ifeq ($(CONFIG_ARCH_RISCV), y)
INCLUDES += -I $(BASE)/kernel/$(CC_KERNEL_VER)/Source/include/ -I $(BASE)/kernel/$(CC_KERNEL_VER)/Source/portable/GCC/RISC-V/
