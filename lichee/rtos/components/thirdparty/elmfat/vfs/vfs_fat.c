...
//fix unused-function
__attribute__((__unused__)) static ssize_t vfs_fat_pread(void *ctx, int fd, void *dst, size_t size, off_t offset)
{
    ssize_t ret = -1;
    vfs_fat_ctx_t *fat_ctx = (vfs_fat_ctx_t *) ctx;
    hal_mutex_lock(fat_ctx->lock);
...
//fix unused-function
__attribute__((__unused__)) static ssize_t vfs_fat_pwrite(void *ctx, int fd, const void *src, size_t size, off_t offset)
{
    ssize_t ret = -1;
    vfs_fat_ctx_t *fat_ctx = (vfs_fat_ctx_t *) ctx;
    hal_mutex_lock(fat_ctx->lock);
...
// fix unused-function
__attribute__((__unused__)) static int vfs_fat_utime(void *ctx, const char *path, const struct utimbuf *times)
{
