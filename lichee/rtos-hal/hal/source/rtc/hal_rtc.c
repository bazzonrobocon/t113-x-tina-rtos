...
int hal_rtc_setalarm(struct rtc_wkalrm *wkalrm)
{
    ...
    u32 alrm;
    time64_t diff;
    __attribute__((__unused__)) unsigned long time_gap;
    __attribute__((__unused__)) unsigned long time_gap_day;
...
int hal_rtc_init(void)
{
    struct hal_rtc_dev *rtc_dev = &sunxi_hal_rtc;
    int ret;
    __attribute__((__unused__)) unsigned int tmp_data;
