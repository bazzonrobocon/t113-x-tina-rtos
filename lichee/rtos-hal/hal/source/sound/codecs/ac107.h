 ...
 */
#define AC107_DAUDIO_FORMAT		SND_SOC_DAIFMT_I2S

#define AC107_DAUDIO_SIG_INV		1

#define AC107_SLOT_WIDTH		32
#define AC107_SLOT			2
#define AC107_PLLCLK_SRC		0
#define	AC107_SYSCLK_SRC		0
#define AC107_PCM_BIT			0
#define AC107_FRAME_SYNC_WIDTH		1
#define AC107_TX_PIN_CHMAP		0x10101010

#define AC107_CHIP_NUM			1

#define AC107_CHIP_TWI_CFG \
{ \
	 .bus = TWI_MASTER_5, .addr = 0x36, \
}
...
struct ac107_param {
	...
	/* according linux */
	unsigned int pllclk_src;
	unsigned int sysclk_src;
	unsigned int pcm_bit_first;
