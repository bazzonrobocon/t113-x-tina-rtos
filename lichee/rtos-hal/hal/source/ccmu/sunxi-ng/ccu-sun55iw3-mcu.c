...
static struct ccu_sdm_setting pll_audio1_sdm_table[] = {
	{ .rate = 2167603200U, .pattern = 0xA000A234, .m = 1, .n = 90 }, /* div2->22.5792 */
	{ .rate = 2359296000U, .pattern = 0xA0009BA6, .m = 1, .n = 98 }, /* div2->24.576 */
...
static const char * const dsp_parents[] = { "dcxo24M", "osc32k", "rc-16m", "pll-audio1-div2", "pll-audio1-div5", "dsp" };
...
static SUNXI_CCU_GATE(mcu_npu_clk, "mcu-npu",
		"dcxo24M",
		0x0070, BIT(0), 0);
...
/* rst_def_start */
static struct ccu_reset_map sun55iw3_mcu_resets[] =
{
...
static struct ccu_common *sun55iw3_mcu_clks[] = {
...
static struct clk_hw_onecell_data sun55iw3_hw_clks =
{
	.hws    = {
		...
		[CLK_BUS_MCU_NPU]			= &mcu_npu_clk.common.hw,
...
static const struct sunxi_ccu_desc sun55iw3_mcu_desc =
{
	.ccu_clks   = sun55iw3_mcu_clks,
	.num_ccu_clks   = ARRAY_SIZE(sun55iw3_mcu_clks),

	.hw_clks    = &sun55iw3_hw_clks,
	.clk_type   = HAL_SUNXI_MCU,

	.resets     = sun55iw3_mcu_resets,
	.reset_type = HAL_SUNXI_MCU_RESET,
	.num_resets = ARRAY_SIZE(sun55iw3_mcu_resets),
};
...
int sunxi_mcu_init(void)
{
	unsigned long reg = (unsigned long)SUNXI_MCU_CCU_BASE;
	int ret;
	int val;
	...
	ret = ccu_common_init(reg, &sun55iw3_mcu_desc);
