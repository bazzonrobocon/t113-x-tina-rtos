...
static struct ccu_common *sun60iw1_rtc_ccu_clks[] = {
	&iosc_clk.common,
...
static struct clk_hw_onecell_data sun60iw1_rtc_ccu_hw_clks = {
	.hws	= {
...
static const struct sunxi_ccu_desc sun60iw1_rtc_ccu_desc = {
	.ccu_clks	= sun60iw1_rtc_ccu_clks,
	.num_ccu_clks	= ARRAY_SIZE(sun60iw1_rtc_ccu_clks),

	.hw_clks	= &sun60iw1_rtc_ccu_hw_clks,
...
int sunxi_rtc_ccu_init(void)
{
    ...
    return ccu_common_init(reg, &sun60iw1_rtc_ccu_desc);
}
