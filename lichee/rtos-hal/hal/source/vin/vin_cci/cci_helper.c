...
// fix unused-function
__attribute__((__unused__)) static int cci_read_a8_d16(int id, unsigned char addr, unsigned short *value)
{
...
// fix unused-function
__attribute__((__unused__)) static int cci_write_a8_d16(int id, unsigned short addr, unsigned short value)
{
	twi_msg_t msg;
	unsigned char data[3];
	int slave_addr;
