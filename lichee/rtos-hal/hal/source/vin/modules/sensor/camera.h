...
#if (DEV_DBG_EN == 1)
#define sensor_dbg(x, arg...) hal_log_debug("[%s_debug]" x, SENSOR_NAME, ##arg)
#else
...
#else
#if (DEV_DBG_EN == 1)
#define sensor_dbg(x, arg...) printk(KERN_WARNING"[%s_debug]" x, SENSOR_NAME, ##arg)
#else
#define sensor_dbg(x, arg...)
#endif
#define sensor_err(x, arg...) printk(KERN_ERR"[%s_ERR]%s, line: %d," x, SENSOR_NAME, \
...
struct sensor_fuc_core {
	...
	struct sensor_format_struct *(*sensor_g_format)(int id, int isp_id, int vinc_id);
...
extern struct sensor_fuc_core gc0406_core;
extern struct sensor_fuc_core gc1054_core;
extern struct sensor_fuc_core gc1084_core;
extern struct sensor_fuc_core tp9950_mipi_core;
extern struct sensor_fuc_core tp9953_dvp_core;
extern struct sensor_fuc_core imx319_core;
extern struct sensor_fuc_core imx335_core;
extern struct sensor_fuc_core sc035hgs_core;
extern struct sensor_fuc_core tp2815_core;
extern struct sensor_fuc_core bf2253l_core;
extern struct sensor_fuc_core n5_core;
