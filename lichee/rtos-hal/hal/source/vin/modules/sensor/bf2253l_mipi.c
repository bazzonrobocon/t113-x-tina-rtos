...
#if SENSOR_25FPS
static struct regval_list sensor_480p120fps_to_1600x1200_25fps[] = {
	
};
#endif

#if SENSOR_20FPS
static struct regval_list sensor_480p120fps_to_1600x1200_20fps[] = {
	
};
#endif

#if SENSOR_15FPS
static struct regval_list sensor_480p120fps_to_1600x1200_15fps[] = {
...
//	}
	*code = MEDIA_BUS_FMT_SRGGB10_1X10; // bf2253l support change the rgb format by itself
...
static struct sensor_format_struct switch_sensor_formats[] = {
...
#if SENSOR_15FPS
	{
		...
		.gain_min   = 1 << 4,
		.gain_max   = 110 << 4,
		.switch_regs	   = sensor_480p120fps_to_1600x1200_15fps,
		.switch_regs_size  = ARRAY_SIZE(sensor_480p120fps_to_1600x1200_15fps),
	},
#endif
#if SENSOR_20FPS
	{
		...
		.gain_min   = 1 << 4,
		.gain_max   = 110 << 4,
		.switch_regs	   = sensor_480p120fps_to_1600x1200_20fps,
		.switch_regs_size  = ARRAY_SIZE(sensor_480p120fps_to_1600x1200_20fps),
	},
#endif
#if SENSOR_25FPS
	{
		...
		.gain_min   = 1 << 4,
		.gain_max   = 110 << 4,
		.switch_regs	   = sensor_480p120fps_to_1600x1200_25fps,
		.switch_regs_size  = ARRAY_SIZE(sensor_480p120fps_to_1600x1200_25fps),
	},
#endif
#if SENSOR_30FPS
	{
...
static int sensor_reg_init(int id, int isp_id)
{
	...
	bf2253l_sensor_vts = current_win[id]->vts;
...
static int sensor_s_switch(int id)
{
	...
	int ret = -1;
	temperature_ctrl = 1;
	bf2253l_sensor_vts = current_switch_win[id]->vts;
...
struct sensor_fuc_core bf2253l_core  = {
