...
#if SENSOR_1080P
static struct regval_list sensor_1920x1088p15_regs[] = {
//version 6.8
//mclk 24Mhz
//mipi_data_rate 648Mbps
//framelength 3000
...
static int sensor_s_exp(int id, unsigned int exp_val, unsigned int exp_short)
{
	...
	if (isp_wdr_mode == ISP_DOL_WDR_MODE) {
		...
		if (!full_size && glb_exp_gain.exp_mid_val != exp_short) {
...
static int sensor_s_exp_gain(int id, struct sensor_exp_gain *exp_gain)
{
	...
	static int rgain_save = 0, bgain_save = 0;
...
static struct sensor_format_struct sensor_formats[] = {
...
#if SENSOR_1080P
	{
		...
		.regs	    = sensor_1920x1088p15_regs,
		.regs_size  = ARRAY_SIZE(sensor_1920x1088p15_regs),
	},
#endif
