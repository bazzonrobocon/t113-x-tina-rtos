...
static const uint32_t hal_twi_address[] =
{
    ...
    SUNXI_TWI5_PBASE,
#endif
#if !(defined(CONFIG_ARCH_SUN8IW20) || defined(CONFIG_ARCH_SUN20IW1) || defined(CONFIG_ARCH_SUN20IW2) || defined(CONFIG_ARCH_SUN20IW3))
    SUNXI_S_TWI0_PBASE,
#endif
#ifdef CONFIG_ARCH_SUN55IW3
    SUNXI_S_TWI1_PBASE,
...
static void twi_slave_reset(hal_twi_t *twi)
{
    ...
    twi_soft_reset(twi->base_addr, TWI_SRST_REG, TWI_SRST_SRST);
