...
typedef struct __UsbBlkDev {
	...
	char ClassName[USB_BULK_DISK_MAX_NAME_LEN]; /* 设备类名, 如"disk" */
	char DevName[USB_BULK_DISK_MAX_NAME_LEN];   /* 此设备名, 如"SCSI_DISK_000" */
...
int UsbBlkDevReg(__UsbBlkDev_t *BlkDev, char *ClassName, unsigned int RegDisk);
