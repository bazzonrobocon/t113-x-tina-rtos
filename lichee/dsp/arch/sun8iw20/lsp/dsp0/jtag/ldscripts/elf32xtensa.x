/* This linker script generated from xt-genldscripts.tpp for LSP /home1/wujiayi/rtos-dsp/lichee/dsp/arch/sun8iw20/lsp/dsp0/jtag */
...
MEMORY
{
  ...
  ddr1_0_seg :                        	org = 0x42000000, len = 0x100
  ddr1_1_seg :                        	org = 0x42000100, len = 0xFFF00
}
...
_memmap_seg_ddr1_0_max   = 0x42000100;
_memmap_seg_ddr1_1_start = 0x42000100;
_memmap_seg_ddr1_1_max   = 0x42100000;
...
SECTIONS
{
  ...
  .bss (NOLOAD) : ALIGN(8)
  {
    ...
    *(.ddr1.bss)
    ...
    _memmap_seg_ddr1_1_end = ALIGN(0x8);
  } >ddr1_1_seg :ddr1_1_bss_phdr
