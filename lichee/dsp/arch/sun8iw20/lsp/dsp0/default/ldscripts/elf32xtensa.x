/* This linker script generated from xt-genldscripts.tpp for LSP /home1/wujiayi/rtos-dsp/lichee/dsp/arch/sun8iw20/lsp/dsp0/default */
...
MEMORY
{
  ...
  extra_mem_0_seg :                   	org = 0x32000000, len = 0x100
  extra_mem_1_seg :                   	org = 0x32000100, len = 0xFFF00
}
...
_memmap_seg_extra_mem_0_max   = 0x32000100;
_memmap_seg_extra_mem_1_start = 0x32000100;
_memmap_seg_extra_mem_1_max   = 0x32100000;
...
SECTIONS
{
  ...
  .version_table : AT(0x42000000) ALIGN(4)
  {
  ...
  .resource_table : AT(0x42000100) ALIGN(4)
  {
