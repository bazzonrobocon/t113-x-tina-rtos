/* This linker script generated from xt-genldscripts.tpp for LSP /home1/wujiayi/rtos-dsp/lichee/dsp/arch/sun8iw20/lsp/dsp0/perf_mem */
...
MEMORY
{
  ...
  extra_mem_9_seg :                   	org = 0x3200123C, len = 0xC4
  extra_mem_10_seg :                  	org = 0x32001300, len = 0x100
  extra_mem_11_seg :                  	org = 0x32001400, len = 0xFEC00
}
...
PHDRS
{
  ...
  extra_mem_11_phdr PT_LOAD;
  extra_mem_11_bss_phdr PT_LOAD;
}
...
_memmap_seg_extra_mem_9_max   = 0x32001300;
_memmap_seg_extra_mem_10_start = 0x32001300;
_memmap_seg_extra_mem_10_max   = 0x32001400;
_memmap_seg_extra_mem_11_start = 0x32001400;
_memmap_seg_extra_mem_11_max   = 0x32100000;
...
SECTIONS
{
  ...
  } >extra_mem_11_seg :extra_mem_11_phdr
  ...
  .bss (NOLOAD) : ALIGN(8)
  {
    ...
    *(.extra_mem.bss)
    ...
    _memmap_seg_extra_mem_11_end = ALIGN(0x8);
  } >extra_mem_11_seg :extra_mem_11_bss_phdr
